					...
					<div class="card-body">
                        ...
                        <div class="row">
							...
							<div class="form-footer">
								<button type="submit" class="btn btn-primary btn-lg btn-block"><i class="fa fa-save"></i> <?php echo e(__lang('save')); ?></button>
							</div>
						 </form>
					</div>
				</div><!--end .box -->
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Muzammil\laravel\codecanyon-19457888-traineasy-training-management-registration-system\Resources\views/admin/certificate/add.blade.php ENDPATH**/ ?>